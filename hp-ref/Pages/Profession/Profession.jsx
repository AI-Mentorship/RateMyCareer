...
function Profession(){
    ...
    useEffect(()=>{
        ...
        async function tryFetchFor(name){
            ...
            try{
                const tJson = await localData.getTimeline(name)
                console.debug('timeline response', { career: name, body: tJson })
                const sJson = await localData.getScores(name)
                console.debug('scores response', { career: name, body: sJson })
        ...
        async function load(){
            try{
                ...
                try{
                    const summaryJson = await localData.getCareerSummaries(result.name || career)
                    console.debug('career_summaries response', { career: result.name || career, body: summaryJson })
                ...
                try{
                    ...
                    console.debug('quotes response', { career: result.name || career, body: qJson })
    ...
    const sentiment = rawScore ? rawScore.avg_sentiment : null
    const regret = rawScore ? rawScore.regret_ratio : null
    const volatility = rawScore ? rawScore.sentiment_volatility : null
    ...
    return (
        <div className="prof-page">
            ...
            <div className="prof-content">
                ...
                <Title 
                    name={careerLabel || effectiveCareer || career} 
                    vibe={vibeToShow} 
                    sentiment={sentiment}
                    regret={regret}
                ...
                <div className="overview-column">
                    ...
                    {summary ? (
                        ...
                        <p>Summary not available for this profession.</p>
                    )}
                </div>
